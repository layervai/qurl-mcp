...
const unsupportedForUploads = (field: string) =>
  z
    ...
    .optional()
    .describe(`Not supported for uploaded files; a non-null ${field} rejects the request.`);
